    ...
    return (
      <div className="rounded-lg border border-destructive bg-destructive/10 p-4">
        <p className="text-destructive">
          {t('ipInfo.error')}: {error instanceof Error ? error.message : t('ipInfo.cannotRetrieve')}
        </p>
        <Button 
        ...
        {data.zip && (
          <div className="mt-4 pt-4 border-t">
            <div className="flex items-center gap-2">
              <span className="text-sm text-muted-foreground">{t('ipInfo.postalCode')}:</span>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-lg border bg-card p-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t('ipInfo.region')}</p>
              <p className="font-semibold">
